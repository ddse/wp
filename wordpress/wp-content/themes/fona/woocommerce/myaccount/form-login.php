        ...
        <form method="post" class="login">
            ...
            <?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes') { ?>
                <a href="#" class="btn btn-show-register light"
                   title="<?php esc_attr_e('Create New Account', 'fona'); ?>"><?php esc_html_e('Create New Account', 'woocommerce'); ?></a>
                <?php
            } ?>
        ...
        <div class="register form" style="display:none">
            ...
            <form method="post" class="register">
                ...
                <a href="#" class="btn btn-show-login light"
                   title="<?php esc_attr_e('Sign In', 'woocommerce'); ?>"><?php esc_html_e('Sign In', 'woocommerce'); ?></a>
